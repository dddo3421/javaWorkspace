...
public class MemberLoginSHA256 {
	...
	public static String sha256(String pass) throws NoSuchAlgorithmException {
		...
		return bytesToHex(md.digest()); //16진수 문자열로 변환시키는 함수 호출
	...
	public static void main(String[] args) throws Exception {
		// 회원가입 시 sha256알고리즘을 사용해서 비밀번호 저장 
		...
		try {
			...
			String memPass  = sha256(sc.nextLine()); //회원가입할 때와 동일한 알고리즘 사용 해시값으로 변경 후 그 값으로 쿼리 구성

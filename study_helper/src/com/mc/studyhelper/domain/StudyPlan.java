...
//SchemaType recommendedProject
public record StudyPlan(String difficulty, String period, String firststepLanguage, String recommendedProject) {
	...
	public static StudyPlan fromMap (Map<String, Object> map) {
		return new StudyPlan((String)map.get("difficulty"),
				...
				(String)map.get("recommendedProject"));
